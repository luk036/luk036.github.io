...
\caption{Timing Constraint Graph 
         (Assume $T_{\mathrm{setup}}$ = $T_{hold}$ = 0)}
\end{figure}
\columnsend
...
- Slack$_{31}$ = 1
  ...
  where Slack$_{ij}$ = CP - D$_{ij}$ - T$_{\mathrm{setup}}$ - Skew$_{ij}$
