...
<pre>
graph LR
    I["Input I"] --> PB["Pre-computer Bank\nalphabets {1,3,5,...}"]
    W["Weight W"] --> SEL["Select Units"]
    PB --> SEL
    SEL --> SH["Shift Units"]
    SH --> ADD["Adder"]
    ADD --> OUT["I &times; W"]
    style I fill:#e3f2fd,stroke:#1565c0,stroke-width:3px
    style W fill:#e3f2fd,stroke:#1565c0,stroke-width:3px
    style PB fill:#c8e6c9,stroke:#2e7d32,stroke-width:3px
    style SEL fill:#fff9c4,stroke:#f57f17,stroke-width:3px
    style SH fill:#fff9c4,stroke:#f57f17,stroke-width:3px
