...
- Specifically, for numbers $0$ to ${\color{coral}n}-1$, you need to pick ${\color{coral}d}$ numbers.
- The goal: When you look at all the **differences between any two picked numbers**, those differences cover a wide range of values (in the RL context: cover every possible remainder when divided by ${\color{coral}n}$).
...
- **${\color{coral}n}$:** The total range of numbers to work with ($0$ to ${\color{coral}n}-1$).
- **${\color{coral}d}$:** How many numbers to include in each set.
- **Constraints:** The program validates that:
- ${\color{coral}n}$ is **at least 3**.
- ${\color{coral}d}$ is **at least 3**.
- ${\color{coral}n}$ doesn't exceed ${\color{coral}d}*({\color{coral}d}-1)+1$.
- **Output:**
...
- **Input:** Takes two **command-line arguments**:
- **${\color{coral}n}$:** The total range of numbers to choose from ($0$ to ${\color{coral}N}-1$).
- **${\color{coral}d}$:** How many numbers you're allowed to pick.
- **Constraints:** The program validates that:
- ${\color{coral}n}$ is **at least 3**.
- ${\color{coral}d}$ is **at least 3**.
- ${\color{coral}n}$ doesn't exceed ${\color{coral}d}*({\color{coral}d}-1)+1$.
