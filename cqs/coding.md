...
- Specifically, for numbers $0$ to ${\color{royalblue}n}-1$, you need to pick ${\color{royalblue}d}$ numbers.
- The goal: When you look at all the **differences between any two picked numbers**, those differences cover a wide range of values (in the RL context: cover every possible remainder when divided by ${\color{royalblue}n}$).
...
- Example for ${\color{royalblue}n}=13$, ${\color{royalblue}d}=4$:
...
- **Example Search for ${\color{royalblue}n}=13$, ${\color{royalblue}d}=4$:**
...
- **${\color{royalblue}n}=13$, ${\color{royalblue}d}=4$ Example:**
...
- **${\color{royalblue}n}$:** The total range of numbers to work with ($0$ to ${\color{royalblue}n}-1$).
- **${\color{royalblue}d}$:** How many numbers to include in each set.
- **Constraints:** The program validates that:
- ${\color{royalblue}n}$ is **at least 3**.
- ${\color{royalblue}d}$ is **at least 3**.
- ${\color{royalblue}n}$ doesn't exceed ${\color{royalblue}d}*({\color{royalblue}d}-1)+1$.
- **Output:**
...
- **${\color{royalblue}n}=13$, ${\color{royalblue}d}=4$ Learning Example:**
...
- **${\color{royalblue}n}=13$, ${\color{royalblue}d}=4$ Episode:**
...
- **Input:** Takes two **command-line arguments**:
- **${\color{royalblue}n}$:** The total range of numbers to choose from ($0$ to ${\color{royalblue}N}-1$).
- **${\color{royalblue}d}$:** How many numbers you're allowed to pick.
- **Constraints:** The program validates that:
- ${\color{royalblue}n}$ is **at least 3**.
- ${\color{royalblue}d}$ is **at least 3**.
- ${\color{royalblue}n}$ doesn't exceed ${\color{royalblue}d}*({\color{royalblue}d}-1)+1$.
