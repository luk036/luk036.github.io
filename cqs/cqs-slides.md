...
- ${\color{salmon}B_2} = \{2, 3, 4, 6\}$
- ${\color{salmon}B_3} = \{3, 4, 5, 7\}$
- ${\color{salmon}B_4} = \{4, 5, 6, 0\}$
- ${\color{salmon}B_5} = \{5, 6, 7, 1\}$
- ${\color{salmon}B_6} = \{6, 7, 0, 2\}$
- ${\color{salmon}B_7} = \{7, 0, 1, 3\}$
- This set forms a valid CQS. ✅
- Equal work: Each quorum has size 4. ⚖️
- Equal responsibility: Each site appears in 4 quorums (e.g., site 0 in ${\color{salmon}B_0}, {\color{salmon}B_4}, {\color{salmon}B_6}, {\color{salmon}B_7}$). 🔄
- Intersection property: E.g., ${\color{salmon}B_0} \cap {\color{salmon}B_1} = \{1, 2\} \neq \emptyset$. ✖️➡️✔️
