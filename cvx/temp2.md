...
![image](ellipsoid.files/region.pdf)
...
![image](ellipsoid.files/iso050.pdf)

: Data Sample (kern=0.5)

] .pull-right[

![image](ellipsoid.files/result050.pdf)
...
![image](ellipsoid.files/iso100.pdf)

: Data Sample (kern=1.0)

] .pull-right[

![image](ellipsoid.files/result100.pdf)
...
![image](ellipsoid.files/iso200.pdf)

: Data Sample (kern=2.0)

] .pull-right[

![image](ellipsoid.files/result200.pdf)
