...
`)===-1?o.indexOf('"')!==-1&&o.indexOf("'")===-1?Fs(o,e):Se(o,e):Vt(t,e,n,r);if(!c&&!f&&i!==p.Type.PLAIN&&o.indexOf(`
`)!==-1)return Vt(t,e,n,r);if(l===""&&Qt(o))return e.forceBlockIndent=!0,Vt(t,e,n,r);let m=o.replace(/\n+/g,`$&
${l}`);if(a){let{tags:y}=e.doc.schema;if(typeof Fn(m,y,y.scalarFallback).value!="string")return Se(o,e)}let d=c?m:jt(m,l,$s,qn(e));return s&&!f&&(d.indexOf(`
`)!==-1||s.indexOf(`
